...
public class ReportsNavigationPanelComponent {
    ...
    private By transactionGeneralReportReportEntery = By.xpath("//a[contains(@href,'/TransactionGeneralReport')]");
    private By transactionFollowUpReportEntery = By.xpath("//a[contains(@href,'/TransactionFollowUpReport')]");
    ...
    private By followUpDetailsReportEntery = By.xpath("//a[contains(@href,'/FollowupDetailsReport')]");
    private By sentTransactionsReportEntery = By.xpath("//a[contains(@href,'/SentTransactionReport')]");
    private By briefcaseDisplayReportEntery = By.xpath("//a[contains(@href,'/BriefcaseDisplayReport')]");



    public ReportsNavigationPanelComponent(SHAFT.GUI.WebDriver driver, HorizontalMenusComponent hMComponent) {
        this.driver = driver;
