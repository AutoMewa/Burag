...
public class TransactionsFollowupPage extends TransactionsNavigationPanelComponent {
    ...
    private By firtFollowupCardNumber = By.xpath("(//div[contains(@class,'box-grid')]//div[contains(@class,'pr-1')])[1]");
    private By numberOfAttachmentsAtFirstFollowup = By.xpath("(//div[contains(@class,'ml-auto')]/div[@class='info']//span)[1]");
    ...
    public int getNumberOfAttachmentsOnFirstCard() {
        ...
        String trimmedNumber = driver.element().getText(numberOfAttachmentsAtFirstFollowup).replaceAll("[^0-9]", "");
