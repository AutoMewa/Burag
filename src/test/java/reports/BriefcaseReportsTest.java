...
public class BriefcaseReportsTest extends TestBase {
    ...
    public void generateBriefcaseReport() {
        ...
        BriefcaseReportPage briefcaseReportPage = myTransactionsPage.getHMComponent().navigateToReportsTab().navigateToBriefcaseReport();
        String fromDate = GeneralOperations.getHijriDateMonthsBefore(1);
